...
use PostNLWooCommerce\Checkout_Blocks\Postnl_Tabs_Extend_Store_Endpoint;

/**
 * Class for integrating with WooCommerce Blocks
 */
class Postnl_Tabs_Blocks_Integration implements IntegrationInterface {
	...
	private function register_main_integration() {
		...
		wp_enqueue_style(
			'postnl-tabs-blocks-integration',
			$style_url,
			[],
	...
	public function get_script_handles() {
		return [ 'postnl-tabs-blocks-integration', 'postnl-tabs-block-frontend' ];
	}
	...
	public function get_editor_script_handles() {
		return [ 'postnl-tabs-blocks-integration', 'postnl-tabs-block-editor' ];
	}
	...
	public function register_shipping_workshop_block_editor_styles() {
		$style_path = '/build/style-postnl-tabs-block.css';
